...
CREATE TABLE user(
        ...
        user_active           Boolean NOT NULL, /*Indique si le compte de l'utilisateur est actif */
...
CREATE TABLE star(
    ...
    'hypergéante', 'étoile_à_neutrons', 'pulsar', 'variable', 'binaire', 'ternaire') NOT NULL  ,
        star_gravity      Float NOT NULL CHECK (star_gravity > 0) /* Doit être supérieur à 0 */  ,
        star_surface_temp Float NOT NULL CHECK (star_surface_temp > -273.15) /* Doit être supérieur ou égal à -273.15°C */  ,
        star_diameter     Int NOT NULL CHECK (star_diameter > 0) /* Doit être supérieur à 0 */  ,
        star_mass         BigInt NOT NULL CHECK (star_mass > 0) /* Doit être supérieur à 0 */  ,
        star_luminosity   Int NOT NULL CHECK (star_luminosity > 0) /* Doit être supérieur à 0 */  ,
...
CREATE TABLE planet(
        ...
        planet_gravity             Float NOT NULL CHECK (planet_gravity >= 0) /* Doit être supérieur à 0 */  ,
        ...
        planet_apogee              Int NOT NULL CHECK (planet_apogee >= 0) /* Doit être supérieur à 0 */  ,
        planet_perigee             Int NOT NULL CHECK (planet_perigee >= 0) /* Doit être supérieur à 0 */  ,
        ...
        planet_average_distance    BigInt NOT NULL CHECK (planet_average_distance >= 0) /* Doit être supérieur à 0 */  ,
        planet_orbital_period      Int NOT NULL CHECK (planet_orbital_period >= 0) /* Doit être supérieur à 0 */  ,
        ...
        planet_rotation_period     Int NOT NULL CHECK (planet_rotation_period >= 0) /* Doit être supérieur à 0 */  ,
        planet_mass                BigInt NOT NULL CHECK (planet_mass >= 0) /* Doit être supérieur à 0 */  ,
        planet_diameter            Int NOT NULL CHECK (planet_diameter >= 0) /* Doit être supérieur à 0 */  ,
        planet_rings               Int NOT NULL CHECK (planet_rings >= 0) /* Doit être supérieur à 0 */  ,
...
CREATE TABLE moon(
        ...
        moon_gravity             Float NOT NULL CHECK (moon_gravity >= 0) /* Doit être supérieur à 0 */  ,
        ...
        moon_apogee              Int NOT NULL CHECK (moon_apogee >= 0) /* Doit être supérieur à 0 */  ,
        moon_perigee             Int NOT NULL CHECK (moon_perigee >= 0) /* Doit être supérieur à 0 */  ,
        ...
        moon_average_distance    BigInt NOT NULL CHECK (moon_average_distance >= 0) /* Doit être supérieur à 0 */  ,
        moon_orbital_period      Int NOT NULL CHECK (moon_orbital_period >= 0) /* Doit être supérieur à 0 */  ,
        ...
        moon_rotation_period     Int NOT NULL CHECK (moon_rotation_period >= 0) /* Doit être supérieur à 0 */  ,
        moon_mass                Int NOT NULL CHECK (moon_mass >= 0) /* Doit être supérieur à 0 */  ,
        moon_diameter            Int NOT NULL CHECK (moon_diameter >= 0) /* Doit être supérieur à 0 */  ,
        moon_rings               Int NOT NULL CHECK (moon_rings >= 0) /* Doit être supérieur à 0 */  ,
